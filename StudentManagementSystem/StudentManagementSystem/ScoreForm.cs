...
namespace StudentManagementSystem
{
    public partial class ScoreForm : Form
    {
        ...
        {
            DataGridView_student.DataSource = score.getList(new MySqlCommand("SELECT score.StudentId,student.StdFirstName,student.StdLastName,score.Score,score.Description FROM student INNER JOIN score ON score.StudentId=student.StdId;"));
        }
        ...
        {
            // TO DISPLAY THE STUDENT LIST ON DATA GRID VIEW
